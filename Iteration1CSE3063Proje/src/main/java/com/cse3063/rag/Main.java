...
public class Main {
    public static void main(String[] args) {
        ...
        corpus.add(createChunk("doc1", "sec1", "Murat Can Ganiz, Bilgisayar Mühendisliği bölümünde öğretim üyesidir. Ofisi MB-342 numaralı odadadır."));
        corpus.add(createChunk("doc2", "sec1", "CSE3063 Object Oriented Software Design dersi 3. sınıf güz dönemindedir. Dersin ön koşulu CSE1142'dir."));
        corpus.add(createChunk("doc3", "sec1", "Mazeret sınavı, geçerli bir mazereti olan öğrenciler için düzenlenir. Mazeret hakkı yalnızca ara sınavlar için geçerlidir."));
